  ...
  return (
    <Layout>
      <Head>
        ...
        <meta
          name="description"
          content="Megapayer's Multi-Chain DEX provides seamless cross-chain trading with non-custodial security, letting you control your private keys."
        />
      </Head>
        ...
        <div className="container mx-auto px-4">
          ...
          >
            <h2 className="text-4xl font-bold mb-6">
              Trade Across <span className="text-primary">All Blockchains</span>
            </h2>
            <p className="text-xl text-gray-300">
              Megapayer DEX breaks down the barriers between blockchains,
              allowing seamless asset transfers and trades without leaving our
              platform.
            </p>
          </motion.div>
          ...
          >
            <div className="bg-dark/30 backdrop-blur-md p-8 rounded-xl text-center transform hover:scale-105 transition-transform duration-300">
              ...
              <p className="text-gray-300">
                Trade directly from Ethereum to Solana, Polkadot to Cardano, or
                any supported blockchain without intermediaries.
              </p>
            </div>
            ...
            <div className="bg-dark/30 backdrop-blur-md p-8 rounded-xl text-center transform hover:scale-105 transition-transform duration-300">
              ...
              <p className="text-gray-300">
                Earn passive income by providing liquidity to our cross-chain
                pools with competitive APY rates.
              </p>
            </div>
            ...
            <div className="bg-dark/30 backdrop-blur-md p-8 rounded-xl text-center transform hover:scale-105 transition-transform duration-300">
              ...
              <p className="text-gray-300">
                Advanced bridging technology ensures cross-chain transactions
                complete in seconds, not minutes or hours.
              </p>
            </div>
          </motion.div>
          ...
          >
            <div className="order-2 md:order-1 p-8">
              ...
              <p className="text-gray-300 mb-6">
                Unlike centralized exchanges that control your assets, Megapayer
                DEX ensures you always maintain ownership of your private keys.
              </p>
              ...
              <ul className="space-y-4 text-gray-300">
                <li className="flex items-start">
                  ...
                  <span className="ml-3">
                    Connect popular wallets like MetaMask, Trust Wallet, or
                    Ledger
                  </span>
                </li>
                <li className="flex items-start">
                ...
                <li className="flex items-start">
                  ...
                  <span className="ml-3">
                    Open-source smart contracts audited by top security firms
                  </span>
                </li>
              </ul>
            </div>
              ...
              <div className="space-y-6">
                <div className="flex items-start">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="text-gray-300">
                      Trade any token from any blockchain in a single interface.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="text-gray-300">
                      Capitalize on price differences between chains for maximum
                      profit.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="text-gray-300">
                      Automatically routes transactions through the most
                ...
                <div className="flex items-start">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="text-gray-300">
                      Easily spread your investments across multiple
                      blockchains.
                    </p>
                  </div>
                </div>
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-xl text-gray-300 mb-10">
              Experience the next generation of decentralized trading with
              Megapayer DEX
            </p>
