  ...
  return (
    <Layout>
      <Head>
        ...
        <meta
          name="description"
          content="Megapayer's non-custodial, censorship-resistant P2P platform for direct peer-to-peer exchange with on-chain escrow for security."
        />
      </Head>
        ...
        <div className="container mx-auto px-4">
          ...
          >
            <h2 className="text-4xl font-bold mb-6">
              Peer-to-Peer <span className="text-primary">Trading</span>
            </h2>
            <p className="text-xl text-gray-300">
              Megapayer's P2P Exchange eliminates intermediaries, enabling
              direct trading between users with built-in security and trustless
              mechanisms.
            </p>
          </motion.div>
          ...
          >
            <div className="bg-dark/30 backdrop-blur-md p-8 rounded-xl text-center transform hover:scale-105 transition-transform duration-300">
              ...
              <p className="text-gray-300">
                You always maintain control of your funds. We never hold your
                private keys or assets in our custody.
              </p>
            </div>
            ...
            <div className="bg-dark/30 backdrop-blur-md p-8 rounded-xl text-center transform hover:scale-105 transition-transform duration-300">
              ...
              <p className="text-gray-300">
                Smart contracts secure your trades by holding funds in escrow
            ...
            <div className="bg-dark/30 backdrop-blur-md p-8 rounded-xl text-center transform hover:scale-105 transition-transform duration-300">
              ...
              <p className="text-gray-300">
                Decentralized arbitration system with community-elected
                mediators ensures fair resolution of disputes.
              </p>
            </div>
          </motion.div>
          ...
          <motion.div
            ...
            initial={{ opacity: 0, y: 30 }}
            animate={
              isEscrowInView ? { opacity: 1, y: 0 } : { opacity: 0, y: 30 }
            }
            transition={{ duration: 0.5 }}
          ...
          >
              ...
              <div className="space-y-6">
                <div className="flex items-start">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="text-gray-300">
                      Post your trading terms or browse existing offers to find
                      a match.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="text-gray-300">
                      The seller's assets are locked in a secure smart contract
                      escrow.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="text-gray-300">
                      The buyer sends payment directly to the seller through the
                      agreed method.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="text-gray-300">
                      After payment confirmation, the escrow releases assets to
                      the buyer.
                    </p>
                  </div>
                </div>
            ...
            <div className="p-8">
              ...
              <p className="text-gray-300 mb-6">
                In traditional exchanges, your transactions can be monitored,
                blocked, or reversed by intermediaries. Our P2P platform ensures
                your freedom to trade without unwarranted interference.
              </p>
              ...
              <ul className="space-y-4 text-gray-300">
                ...
                <li className="flex items-start">
                  ...
                  <span className="ml-3">
                    Trade across borders without restrictions
                  </span>
                </li>
                <li className="flex items-start">
                  <svg
                  ...
                  <span className="ml-3">
                    Private trading with encrypted communications
                  </span>
                </li>
                <li className="flex items-start">
                  <svg
                  ...
                  <span className="ml-3">
                    Resilient infrastructure distributed across the network
                  </span>
                </li>
              </ul>
            </div>
        ...
        <div className="container mx-auto px-4">
          ...
          >
            <h2 className="text-3xl md:text-4xl font-bold mb-8">
              Start Trading on Megapayer P2P
            </h2>
