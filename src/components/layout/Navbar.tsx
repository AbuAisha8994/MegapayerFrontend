  ...
  const navigationLinks: NavItem[] = [
    {
      ...
      href: "/blockchain",
      submenu: [
        { name: "EVM Compatible", href: "/blockchain/evm" },
        { name: "AI Smart Contracts", href: "/blockchain/ai-contracts" },
        { name: "DeFi Support", href: "/blockchain/defi" },
        { name: "NFT Support", href: "/blockchain/nft" },
        { name: "Validator Nodes", href: "/blockchain/validators" },
      ],
    },
    {
      name: "Explorer & IDE",
      href: "/explorer",
      submenu: [
        { name: "Block Explorer", href: "/explorer/blocks" },
        { name: "Developer IDE", href: "/explorer/ide" },
        { name: "Smart Contract Audit", href: "/explorer/audit" },
      ],
    },
    {
      name: "Bridge",
      href: "/bridge",
      submenu: [
        { name: "Cross-Chain Bridge", href: "/bridge/cross-chain" },
        { name: "Asset Transfer", href: "/bridge/assets" },
        { name: "Bridge Security", href: "/bridge/security" },
      ],
    },
    {
      name: "Web3 Wallet",
      href: "/wallet",
      submenu: [
        { name: "Multichain Support", href: "/wallet/multichain" },
        { name: "Travel Services", href: "/wallet/travel" },
        { name: "Mobile Top-up", href: "/wallet/topup" },
        { name: "Gift Cards", href: "/wallet/gift-cards" },
      ],
    },
    {
      name: "DEX",
      href: "/dex",
      submenu: [
        { name: "Multichain DEX", href: "/dex/multichain" },
        { name: "Liquidity Pools", href: "/dex/liquidity" },
        { name: "Staking", href: "/dex/staking" },
        { name: "Analytics", href: "/dex/analytics" },
      ],
    },
    {
      name: "P2P Exchange",
      href: "/p2p",
      submenu: [
        { name: "Decentralized Trading", href: "/p2p/trading" },
        { name: "Escrow System", href: "/p2p/escrow" },
        { name: "Reputation System", href: "/p2p/reputation" },
      ],
    },
    {
      name: "Docs",
