  ...
  const connections = useMemo(() => {
    ...
    users.forEach((user, i) => {
      ...
      for (let c = 0; c < connectionCount; c++) {
        ...
        const j =
          (i + Math.floor(Math.random() * (users.length - 1)) + 1) %
          users.length;
  ...
  return (
    <group ref={groupRef}>
      ...
      <group position={[-6, -4, 0]}>
        <Text fontSize={0.5} color="#10b981" anchorX="center" anchorY="middle">
          Privacy-First
        </Text>
      </group>

      <group position={[6, -5, 0]}>
        <Text fontSize={0.5} color="#4f46e5" anchorX="center" anchorY="middle">
          User-Owned Content
        </Text>
      </group>

      <group position={[0, -6, 0]}>
        <Text fontSize={0.5} color="#f59e0b" anchorX="center" anchorY="middle">
          Creator Economy
        </Text>
      </group>
    </group>
