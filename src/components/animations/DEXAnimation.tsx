...
const DEXAnimation = () => {
  ...
  const chains = [
    { id: 'chain1', name: 'MEGA', color: '#4f46e5', radius: 1.6, speed: 0.15, startAngle: 0 },
    { id: 'chain2', name: 'ETH', color: '#818cf8', radius: 1.6, speed: -0.12, startAngle: Math.PI * 0.5 },
    { id: 'chain3', name: 'BTC', color: '#f59e0b', radius: 1.6, speed: 0.18, startAngle: Math.PI },
    { id: 'chain4', name: 'SOL', color: '#10b981', radius: 1.6, speed: -0.14, startAngle: Math.PI * 1.5 }
  ];
    ...
    <group ref={groupRef}>
      ...
      <group ref={chainsRef}>
        {chains.map((chain, index) => (
          <group key={chain.id} position={[0, 0, 0]} rotation={[Math.PI/2, 0, chain.startAngle]}>
            {/* Chain ring */}
